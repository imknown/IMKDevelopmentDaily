...
### 小例子: 显示 100dp
1440^2 + 2560^2 = 8627200 →→算术平方根→→ 2937.20956
1080^2 + 1920^2 = 4852800 →→算术平方根→→ 2202.90717
 800^2 + 1280^2 = 2278400 →→算术平方根→→ 1509.43698
 768^2 + 1280^2 = 2228224 →→算术平方根→→ 1492.72369
 720^2 + 1280^2 = 2156800 →→算术平方根→→ 1468.60478
 480^2 +  800^2 =  870400 →→算术平方根→→  932.95230

| 手机型号  | DPS   | PPI    | DPI    | density | sr        | srWdp  | srWdp / 100dp |
| -------- | ----  | ------ | ------ | ------- | --------- | ------ | ------------- |
...
| Nexus 5  | 4.95″ | 445.03 | xxhdpi | 3       | 1080x1920 | 360    | 3.6           |

| Nexus 4  | 4.7″  | 445.03 | xhdpi  | 2       | 768x1280  | 384    | 3.84          |
